...
from src.datamodules.components.pascalvoc_dataset import PascalVOCDataset
...
class PascalVOCDataModule(LightningDataModule):
    ...
    def __init__(
        self,
        data_dir: str = "data/",
        train_val_test_split: Tuple[int, int, int] = (1000, 464),
        batch_size: int = 64,
        num_workers: int = 0,
...
if __name__ == "__main__":
    ...
    print("train", image.shape, label.shape, len(dm.data_train))

    # image, label = dm.data_val[0]
    # print("val", image.shape, label.shape, len(dm.data_val))

    # image, label = dm.data_test[0]
    # print("test", image.shape, label.shape, len(dm.data_test))
